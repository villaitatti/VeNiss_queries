...
-- #################################################
-- update feature_sources according to the QGIS tables
-- #################################################
...
(
	...
	FROM PUBLIC.qgis_sansecondo_buildings 
	WHERE "Today" IS TRUE
  AND NOT EXISTS (SELECT * FROM PRODUCTION.feature_sources WHERE feature_sources.identifier = qgis_sansecondo_buildings.identifier)
);
...
(
	...
	FROM PUBLIC.qgis_sansecondo_islands
	WHERE "Today" IS TRUE
  AND NOT EXISTS (SELECT * FROM PRODUCTION.feature_sources WHERE feature_sources.identifier = qgis_sansecondo_islands.identifier)
);
...
(
	...
	FROM PUBLIC.qgis_sansecondo_open_spaces
	WHERE "Today" IS TRUE
  AND NOT EXISTS (SELECT * FROM PRODUCTION.feature_sources WHERE feature_sources.identifier = qgis_sansecondo_open_spaces.identifier)
);
