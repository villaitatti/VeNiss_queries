...
CREATE TABLE PUBLIC.qgis_sansecondo_islands(
  identifier varchar(100) NOT NULL PRIMARY KEY DEFAULT 'SSC_IS_'::TEXT,
...
INSERT INTO PUBLIC.qgis_sansecondo_islands(identifier, "Today", "1982: Ortofoto", "1943-45: RAF", "1850: Direzione genio militare", "1838-41: Censo Stabile, Mappe Austriache - rettifica", "1789", "1697", geometry)
SELECT DISTINCT
  identifier,
  BOOL_OR(
