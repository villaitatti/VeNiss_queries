...
-- Create a sequence to use as primary key
CREATE SEQUENCE IF NOT EXISTS SS_BLDG_sequence
  START WITH 58
  INCREMENT BY 1
  NO MINVALUE
  NO MAXVALUE
...
CREATE TABLE PUBLIC.qgis_sansecondo_buildings(
  identifier varchar(100) NOT NULL PRIMARY KEY DEFAULT 'SS_BLDG_'|| nextval('SS_BLDG_sequence'::regclass)::TEXT,
